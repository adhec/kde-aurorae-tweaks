...
Decoration {
    ...
    Item {
        ...
        width: 30
        height: decoration.client.height
        Component.onCompleted: {
    ...
    AuroraeButtonGroup {
        ...
        anchors {
            right: root.right
            rightMargin: decoration.client.maximized ? auroraeTheme.titleEdgeLeftMaximized : (auroraeTheme.titleEdgeLeft + root.padding.left)            
        }
    }
